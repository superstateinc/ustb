...
contract SuperstateTokenTestBase is TokenTestBase {
    ...
    function testTokenName() public virtual {
        assertEq(SuperstateTokenV1(address(token)).name(), "Superstate Short Duration US Government Securities Fund");
    }

    function testTokenSymbol() public virtual {
        assertEq(SuperstateTokenV1(address(token)).symbol(), "USTB");
    }
    ...
    function testTransferRevertInsufficentBalance() public {
        ...
        vm.expectRevert(ISuperstateTokenV1.InsufficientAvailableBalance.selector);
    ...
    function testSelfEncumberanceReverts() public {
        ...
        vm.prank(alice);
        vm.expectRevert(ISuperstateTokenV1.SelfEncumberNotAllowed.selector);
    ...
    function testReleaseInsufficientEncumbrance() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ISuperstateTokenV1.InsufficientEncumbrance.selector);
    ...
    function testBulkMintRevertInvalidArgumentLengths() public {
        ...
        vm.expectRevert(ISuperstateTokenV1.InvalidArgumentLengths.selector);
        token.bulkMint(dsts, amounts);
    ...
    function testCannotDoubleUnpause() public {
        ...
        token.accountingUnpause();
        vm.expectRevert(ISuperstateTokenV1.AccountingIsNotPaused.selector);
        token.accountingUnpause();
    ...
    function testPermitRevertsForBadOwner() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ISuperstateTokenV1.BadSignatory.selector);
    ...
    function testPermitRevertsForExpiredSignature() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ISuperstateTokenV1.SignatureExpired.selector);
        token.permit(eve, bob, allowance, expiry, v, r, s);
    ...
    function testPermitRevertsInvalidS() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ISuperstateTokenV1.InvalidSignatureS.selector);
